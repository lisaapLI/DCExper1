        ...
        <div style={s.card}>
          ...
          <div style={s.form}>
            <div style={s.field}>
              ...
              <input
                type="text" inputMode="numeric" placeholder="Masukkan NIM kamu"
                value={form.nim}
                onChange={(e) => { setForm(f => ({ ...f, nim: e.target.value.replace(/\D/g,"") })); setErrors(er => ({ ...er, nim: undefined })); }}
            ...
            <div style={s.field}>
              ...
              <div style={s.pwWrapper}>
                <input
                  type={showPw ? "text" : "password"} placeholder="Masukkan password"
                  value={form.password}
